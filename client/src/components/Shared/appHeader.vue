<template>
     <div class="header-container">
      <nav class="flex w-full px-2">
        ...
        <router-link :to="{name:'NewBookmarkPage'}" class="w-8 h-8 flex items-center justify-center rounded-md transition-colors duration-500 hover:bg-gray-200 group-focus-within:bg-gray-300">
